                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                ...
                                <a type="button" href="{{ route('products.create') }}" class="btn btn-success addButton"> + Add Product</a>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @endif"></td>
                                               <td> 
                                                <a href="{{ url('/products/' . $data['id'] . '/edit') }}"><span class="label label-warning">Edit</span></a>
