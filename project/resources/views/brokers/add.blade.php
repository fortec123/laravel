...
<div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('brokers') }}">Brokers</a></li>
                        <li class="breadcrumb-item active">Add Brokers</li>
                    </ol>
                </div>
                <div>
                                ...
                                <form method='post' action="{{ route('brokers.store') }}">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <input type="reset" class="btn btn-inverse" value="Cancel" />
                                             <a href="{{ url('brokers') }}"><button type="button" class="btn btn-info">Back</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
