                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form method='post' action="{{route('currencies.update', [$currencies->id])}}" enctype="multipart/form-data">
                                    @csrf
                                     {{ method_field('PATCH') }}
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                 <div class="form-group">
                                                    ...
                                                    <input type="text" id="NumCode" name='NumCode'class="form-control" placeholder="Enter Code" value="{{ $currencies->NumCode }}">
                                             ...
                                             <div class="col-md-6">
                                                 <div class="form-group">
                                                    ...
                                                    <input type="text" id="CharCode" name='CharCode'class="form-control" placeholder="Enter CharCode" value="{{ $currencies->CharCode }}">
                                             ...
                                             <div class="col-md-6">
                                                 <div class="form-group">
                                                    ...
                                                    <input type="text" id="Nominal" name='Nominal'class="form-control" placeholder="Enter Nominal" value="{{ $currencies->Nominal }}">
                                             ...
                                             <div class="col-md-6">
                                                 <div class="form-group">
                                                    ...
                                                    <input type="text" id="Name" name='Name'class="form-control" placeholder="Enter Code" value="{{ $currencies->Name }}">
                                                    @if($errors->has('Name'))
                                             ...
                                             <div class="col-md-6">
                                                 <div class="form-group">
                                                    ...
                                                    <input type="text" id="Value" name='Value'class="form-control" placeholder="Enter Code" value="{{ $currencies->Value }}">
                                                    @if($errors->has('Value'))
