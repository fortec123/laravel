                                ...
                                <div class="tab-pane active" id="settings" role="tabpanel">
                                    ...
                                    @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="name" placeholder="Enter First Name" class="form-control form-control-line" value="{{ $data->name }}">
                                                </div>
                                                @if($errors->has('name'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="email" placeholder="Enter Email" class="form-control form-control-line" value="{{ $data->email }}" readonly>
                                                </div>
                                                @if($errors->has('email'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="phone_no" placeholder="Enter Phone No" class="form-control form-control-line" value="{{ $data->phone_no }}">
                                                </div>
