                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a  href="{{ url('home') }}" aria-expanded="false"><i class="mdi mdi-gauge"></i>Home </a> <!--<span class="hide-menu">Dashboard <span class="label label-rouded label-themecolor pull-right">4</span></span></a>
                         ...
                         <li> <a  href="{{ url('notes') }}" aria-expanded="false"><i class=" fa fa-plus"></i>Add Notes </a> <!--<span class="hide-menu">Dashboard <span class="label label-rouded label-themecolor pull-right">4</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="index.html">Minimal </a></li>
                                <li><a href="index2.html">Analytical</a></li>
                                <li><a href="index3.html">Demographical</a></li>
