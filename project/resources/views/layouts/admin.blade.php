...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('public/admin/assets/images/logo5.png') }}">
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
                         <img src="{{ asset('public/admin/assets/images/logo6.png') }}" alt="homepage" class="dark-logo" style="width: 90px" />
                         <!-- Light Logo text -->    
                         <img src="{{ asset('public/admin/assets/images/logo6.png') }}" class="light-logo" alt="homepage" style="width: 90px" /></span> </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
                <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="@if(!empty(auth()->user()->image))
                                            ...
                                            @else
                                              {{ url('storage/app/images/default.png') }}
                ...
                <nav class="sidebar-nav">
                    ...
                    @elseif(auth()->user()->is_admin == 2)
                     ...
                     <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu">Add/See Employee</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('employees') }}">See Employee</a></li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-address-book"></i><span class="hide-menu">Add/See Source</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('sources') }}">See Source</a></li>
                                <li><a href="{{ url('sources/create') }}">Add Source</a></li>
                                
                            </ul>
                        </li>

                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-check-square-o"></i><span class="hide-menu">Add/See Leads</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('leads/create') }}">Add Leads</a></li>
                                <li><a href="{{ url('import') }}">Upload Bulk Leads</a></li>
                                <li><a href="{{ url('leads') }}">See Leads</a></li>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a  href="{{ url('home') }}" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Home</span> </a> <!--<span class="hide-menu">Dashboard <span class="label label-rouded label-themecolor pull-right">4</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="index.html">Minimal </a></li>
                                <li><a href="index2.html">Analytical</a></li>
                                <li><a href="index3.html">Demographical</a></li>
                         ...
                         <!--<li> <a  href="{{ url('analysis') }}" aria-expanded="false"><i class=" fa fa-line-chart"></i>Analysis </a>
                        </li>-->

              

                       <!-- <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu">Broker Management</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('brokers') }}">See Brokers</a></li>
                                <li><a href="{{ url('brokers/create') }}">Add Broker</a></li>
                                
                            </ul>
                        </li>-->


                         <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu">Users</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('users') }}">See Users</a></li>
                          ...
                          <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-gift"></i><span class="hide-menu">Currencies</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('currencies') }}">See Currencies</a></li>
                                <li><a href="{{ url('currencies/create') }}">Add Currency</a></li>
                                
                            </ul>
                        </li>


                         <!--- <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-list-alt"></i><span class="hide-menu">Categories</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('categories') }}">See Categories</a></li>
                                <li><a href="{{ url('categories/create') }}">Add Category</a></li>
                                
                            </ul>
                        </li>

                          <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-product-hunt"></i><span class="hide-menu">Products</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('products') }}">See Products</a></li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-shopping-cart"></i><span class="hide-menu">Orders</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('orders') }}">See Orders</a></li>
                      
                                
                            </ul>
                        </li>

                          <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-inr"></i><span class="hide-menu">Payments</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('payments') }}">See Payments</a></li>
                    
                                
                            </ul>
                        </li>

                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-gift"></i><span class="hide-menu">Promo Codes</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('promocodes') }}">See PromoCodes</a></li>
                                <li><a href="{{ url('promocodes/create') }}">Add PromoCode</a></li>
                                
                            </ul>
                        </li>

                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-snowflake-o"></i><span class="hide-menu">Ingredients</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('ingredients') }}">See Ingredients</a></li>
                         ...
                         <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-sliders"></i><span class="hide-menu">Sliders</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{ url('sliders') }}">See Sliders</a></li>
                                <li><a href="{{ url('sliders/create') }}">Add Slider</a></li>
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
            <footer class="footer">
                © 2020 Egg App by Fortec Solutions
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
