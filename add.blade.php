                                        ...
                                        <div class="row p-t-20">
                                             ...
                                             <div class="row p-t-20">
                                                ...
                                                <div class="col-md-6">
                                                 <div class="form-group">
                                                    ...
                                                    <input type="text" id="actual_price" name='actual_price'class="form-control" placeholder="Enter Actual Price" value="{{ old('actual_price') }}">
                                            ...
                                            <div class="row p-t-20">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="sale_price" name='sale_price'class="form-control" placeholder="Enter Sale Price" value="{{ old('sale_price') }}">
                                        ...
                                        <div class="row p-t-20">
                                             ...
                                             <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="discount" name='discount'class="form-control" placeholder="Enter Discount" value="{{ old('discount') }}">
